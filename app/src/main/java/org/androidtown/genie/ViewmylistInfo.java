 ...
 */
public class ViewmylistInfo extends Activity{

    String url = new IP().IP();
    TextView sub;
    TextView cont;
    String idRequest;
    String subject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Id ider = (Id)intent.getExtras().getSerializable("emailidRequest");
        idRequest = ider.idRequest;
        email = ider.email;
    ...
    public void onreservconfButton(View v){
        Intent intent = new Intent(getApplicationContext(),ReservConf.class);
